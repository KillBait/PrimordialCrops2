 ...
 */
public class CrucioInfusedDirt extends PrimordialBlockBase {
	public CrucioInfusedDirt() {
		super(Material.GROUND, "CrucioInfusedDirt");
	...
	public void registerItemModel(Item itemBlock) {
		PrimordialCrops2.proxy.registerItemRenderer(itemBlock, 0, "CrucioInfusedDirt");
	}
}
