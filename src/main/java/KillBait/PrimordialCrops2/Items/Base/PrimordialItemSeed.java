package KillBait.PrimordialCrops2.Items.Base;
 ...
 */
public class PrimordialItemSeed extends ItemSeeds implements net.minecraftforge.common.IPlantable/*, ItemModelProvider*/ {
	...
	public PrimordialItemSeed(Block crops, Block soil, String regName) {
		super(crops, soil);
